...
const styleUrl = siteUrl + 'static/css/socialshare.css';
const minWidth = 250;
const minHeight = 250;
...
function socialShareLaunch() {
  socialshare = document.getElementById('socialshare');
  var imagesFound = socialshare.querySelector('.images');
  ...
  // close event
  socialshare.querySelector('#close')
